...
public class Main
{
    ...
    private static Logger loggerNotFound;
    private static Logger loggerSearchHistory;
    ...
    public static void main(String[] args)
    {
        ...
        loggerNotFound = LogManager.getLogger("not");
        loggerSearchHistory = LogManager.getLogger("find");
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            if(station != null) {
                loggerSearchHistory.info("Ввели станцию: " + line);
                return station;
            }
            loggerNotFound.debug("Станция не найдена: " + line);
